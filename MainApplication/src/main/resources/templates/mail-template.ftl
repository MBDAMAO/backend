    ...
    <table cellpadding="0" align="center"
        ...
        <tr>
            <th valign="middle"
                ...
                <font face="微软雅黑" size="5" style="color: rgb(255, 255, 255); ">邮箱验证 / Email Verification </font>
            </th>
        </tr>
        <tr>
            <td style="word-break:break-all">
                <div style="padding:25px 35px 40px; background-color:#fff;opacity:0.8;">
                    ...
                    <!-- 中文 -->
                    <p>您好！感谢您使用Damao，您的账号正在进行邮箱验证，验证码为：<font color="#ff8c00">{0}</font>，有效期10分钟，请尽快填写验证码完成验证！</p><br>
                    <!-- 英文 -->
                    <h2 style="margin: 5px 0px; ">
                        <font color="#333333" style="line-height: 20px; ">
                            <font style="line-height: 22px; " size="4">
                    ...
                    <p>Hello! Thanks for using Damao, your account is being authenticated by email, the
                        verification code is:<font color="#ff8c00">{0}</font>, valid for 10 minutes. Please fill in the
                        verification code as soon as
                        possible!</p>
                    <div style="width:100%;margin:0 auto;">
                        <div style="padding:10px 10px 0;border-top:1px solid #ccc;color:#747474;margin-bottom:20px;line-height:1.3em;font-size:12px;">
                            <p>Damao团队</p>
                            <p>联系我们：3034906016@qq.com</p>
                            <br>
                            <p>此为系统邮件，请勿回复<br>
